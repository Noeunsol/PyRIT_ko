...
# Data definition paths under prompts/score/
SCORER_DATA_PATH = pathlib.Path(PROMPTS_PATH, "score").resolve()
...
HARM_DEFINITION_PATH = pathlib.Path(PROMPTS_PATH, "harm_definition").resolve()

JAILBREAK_TEMPLATES_PATH = pathlib.Path(PROMPTS_PATH, "jailbreak", "templates").resolve()
